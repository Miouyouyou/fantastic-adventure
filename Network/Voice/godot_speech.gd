...
const gdnlib_const = preload("res://bin/godot_speech.gdnlib")
var godot_speech_nativescript: NativeScript = preload("res://bin/godot_speech.gdns")
...
func start_recording() -> bool:
	if godot_speech:
		recording = godot_speech.start_recording()
		return recording
...
func end_recording() -> bool:
	if godot_speech:
		recording = !godot_speech.end_recording()
		return recording
