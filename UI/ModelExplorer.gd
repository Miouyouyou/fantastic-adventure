...
# reason: String, endpoint_url: String, form_data: Dictionary, callback: String, extra_arg
...
func _ready():
	...
	sketchfab_list_models({"license": "by", "downloadable": true, "max_face_count": 20000})
